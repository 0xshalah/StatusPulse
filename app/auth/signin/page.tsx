...
export default function SignIn() {
  return (
    <div className="flex min-h-screen bg-background">
      ...
      <div className="hidden flex-1 flex-col justify-between bg-muted/30 p-12 lg:flex">
        <div>
          <Link href="/" className="flex items-center gap-4 mb-8">
            ...
            <span className="font-display text-3xl font-bold tracking-tight">StatusPulse</span>
          </Link>
      ...
      {/* Right: Auth form */}
      <div className="flex flex-1 flex-col items-center justify-center px-6 -mt-20">
        {/* Mobile logo — centered, slightly above middle */}
