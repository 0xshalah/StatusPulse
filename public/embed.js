 ...
 *   data-color    — Accent color (default: StatusPulse pink #e1567c)
...
(function () {
  ...
  var defaultColor = window.matchMedia && window.matchMedia('(prefers-color-scheme: dark)').matches ? '#e1567c' : '#e1567c';
  var color = (script && script.getAttribute('data-color')) || defaultColor;
